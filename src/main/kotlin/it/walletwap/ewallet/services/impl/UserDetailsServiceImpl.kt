...
@Service
@Transactional
class UserDetailsServiceImpl(val userRepository: UserRepository, val customerRepository: CustomerRepository) :
    UserDetailsService, Extensions() {
    ...
    override fun registerUser(userdto: UserDetailsDTO): Optional<UserDetailsDTO>? {
        ...
        val customer = Customer(
            ...
            deliveryAddress = userdto.address,
